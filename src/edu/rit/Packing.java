...
// Exported operations for byte-to-short packing.
     ...
     * @throws NullPointerException      (unchecked exception) Thrown if <TT>src</TT> is null.
     * @throws IndexOutOfBoundsException (unchecked exception) Thrown if packing would cause accessing array
     ...
     * @throws NullPointerException      (unchecked exception) Thrown if <TT>src</TT> is null. Thrown if
     *                                   <TT>dst</TT> is null.
     * @throws IndexOutOfBoundsException (unchecked exception) Thrown if packing would cause accessing array
...
// Exported operations for short-to-byte unpacking.
     ...
     * @throws NullPointerException      (unchecked exception) Thrown if <TT>dst</TT> is null.
     * @throws IndexOutOfBoundsException (unchecked exception) Thrown if unpacking would cause accessing array
     *                                   elements out of bounds; in this case <TT>dst</TT> is not altered.
     */

...
// Exported operations.
     ...
     * @return Hexadecimal string.
     * @throws NullPointerException (unchecked exception) Thrown if <TT>val</TT> is null.
     */
    public static String toString
    (byte[] val) {
     ...
     * @return Hexadecimal string.
     * @throws NullPointerException      (unchecked exception) Thrown if <TT>val</TT> is null.
     * @throws IndexOutOfBoundsException (unchecked exception) Thrown if <TT>off</TT> &lt; 0, <TT>len</TT>
     ...
     * @return Value.
     * @throws NullPointerException     (unchecked exception) Thrown if <TT>str</TT> is null.
     * @throws IllegalArgumentException (unchecked exception) Thrown if any character of the string is not a
     ...
     * @throws NullPointerException     (unchecked exception) Thrown if <TT>str</TT> is null or <TT>val</TT>
     *                                  is null.
     * @throws IllegalArgumentException (unchecked exception) Thrown if any character of the string is not a
     *                                  hexadecimal digit (<TT>'0'</TT> .. <TT>'9'</TT>, <TT>'a'</TT> ..
     *                                  <TT>'f'</TT>, or <TT>'A'</TT> .. <TT>'F'</TT>).
     ...
     * @throws NullPointerException     (unchecked exception) Thrown if <TT>str</TT> is null or <TT>val</TT>
     *                                  is null.
     * @throws IllegalArgumentException (unchecked exception) Thrown if <TT>off</TT> &lt; 0, <TT>len</TT>
...
// Hidden operations.
     ...
     *
     * @param str Hexadecimal digit.
     * @return Value.
     * @throws IllegalArgumentException (unchecked exception) Thrown if <TT>digit</TT> is not a hexadecimal
